...
This document defines the structural, visual, accessibility, and messaging standards for the PHIERS movement site.

No structural, visual, navigational, or messaging changes may be made that conflict with these standards without explicit written approval from the Movement Lead.
...
111-Second Video Block

Core Positioning Section

Supporting Movement Sections (existing copy preserved)

Footer (movement identity block)
...
14. Definition of Done (Homepage)
